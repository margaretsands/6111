...
#
# Generated by export_simulation on Sun Nov 25 22:08:39 EST 2018
#
################################################################################
...
switch to the './bram_fft.sh' script.

./bram_fft.sh -reset_run
...
./bram_fft.sh -noclean_files

For more information on the script, please type './bram_fft.sh -help'.
