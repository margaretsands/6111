...
#
# Generated by export_simulation on Sun Nov 25 22:08:38 EST 2018
#
################################################################################
...
switch to the './bram_frame.sh' script.

./bram_frame.sh -reset_run
...
./bram_frame.sh -noclean_files

For more information on the script, please type './bram_frame.sh -help'.
